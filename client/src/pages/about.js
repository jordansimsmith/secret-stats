      ...
      <Container>
        ...
        <Segment>
          ...
          <p>
            ...
            a majority, and the fascists, who are hidden to everyone but each
            other. If the liberals can learn to trust each other, they have
            enough votes to control the elections and save the day. But the
            fascists will say whatever it takes to get elected, advance their
            agenda, and win the game.
          </p>
          ...
          <p>
            ...
            on the boards and wooden placards for the Chancellor and President.
          </p>
        ...
        <Segment>
          ...
          <p>
            ...
            inspected on a per-user basis. Most importantly, various statistics
            concerning each user’s performance in different roles are
            calculated.
          </p>
